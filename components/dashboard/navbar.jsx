                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        ...
                        <a href="#" class="flex ml-2 md:mr-24">
                            <Image src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="FlowBite Logo" width={32} height={32} />
                            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-blue-600 dark:text-white">Flowbite</span>
                        </a>
                            ...
                            <div>
                                <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                                    <div class="flex-shrink-0">
                                        <Image class="rounded-full w-11 h-11" src="/images/users/bonnie-green.png" alt="Jese image" width={32} height={32} />
                                ...
                                <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                                    <div class="flex-shrink-0">
                                        <Image class="rounded-full w-11 h-11" src="/images/users/jese-leos.png" alt="Jese image" width={32} height={32} />
                                ...
                                <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                                    <div class="flex-shrink-0">
                                        <Image class="rounded-full w-11 h-11" src="/images/users/joseph-mcfall.png" alt="Joseph image" width={32} height={32} />
                                ...
                                <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                                    <div class="flex-shrink-0">
                                        <Image class="rounded-full w-11 h-11" src="/images/users/leslie-livingston.png" alt="Leslie image" width={32} height={32} />
                                ...
                                <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <div class="flex-shrink-0">
                                        <Image class="rounded-full w-11 h-11" src="/images/users/robert-brown.png" alt="Robert image" width={32} height={32} />
                        ...
                        <div class="flex items-center ml-3">
                            <div>
                                <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                                    ...
                                    <Image class="w-8 h-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo" width={32} height={32} />
                                </button>
                            </div>
