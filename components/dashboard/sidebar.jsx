              ...
              <ul className="pb-2 space-y-2">
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="ml-3" sidebar-toggle-item={false}>
                      Dashboard
                    </span>
                  </a>
                </li>
                <li>
                  <button
                    ...
                    onClick={() => toggleCollapsible("dropdown-layouts")}
                  >
                    <svg
                ...
                <li>
                  <button
                    ...
                    onClick={() => toggleCollapsible("dropdown-crud")}
                  >
                    <svg
                      className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                      fill="currentColor"
                ...
                <li>
                  <button
                    ...
                    onClick={() => toggleCollapsible("dropdown-pages")}
                  >
                    <svg
                      className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                      fill="currentColor"
                ...
                <li>
                  <button
                    ...
                    onClick={() => toggleCollapsible("dropdown-auth")}
                  >
                    <svg
                      className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                      fill="currentColor"
                ...
                <li>
                  <button
                    ...
                    onClick={() => toggleCollapsible("dropdown-playground")}
                  >
                    <svg
                      className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                      fill="currentColor"
